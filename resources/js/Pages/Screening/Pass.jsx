...
export default function ScreeningPass({ auth, questions }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Skrining PASS (Perinatal Anxiety)</h2>}
        >
            <Head title="Skrining PASS" />
