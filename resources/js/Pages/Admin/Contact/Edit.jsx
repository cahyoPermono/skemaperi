...
export default function AdminContactEdit({ auth, contact }) {
    const { data, setData, put, processing, errors } = useForm({
        name: contact.name || '',
        type: contact.type || 'Puskesmas',
        phone: contact.phone || '',
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Kontak</h2>}
        >
